...
# 1017 "c:\\mingw\\include\\stdio.h" 3
...
double divide(int a, int b) {
    if (b == 0) {
        do{ longjmp(buf, (1u)); strncpy(error_code, "div by 0", 50); }while (0);
    }
    return (double)a / b;
}
