...
Loại bỏ sản phẩm không muốn mua:
...
Tính toán tổng tiền:
Tính toán tổng tiền khi thêm sản phẩm vào giỏ hàng:
...
Tính toán tổng tiền khi loại bỏ sản phẩm khỏi giỏ hàng:
...
Giảm số lượng sản phẩm đã mua từ tổng số lượng có sẵn:
...
Lưu trữ lịch sử giao dịch (tuỳ chọn):
...
Hiển thị thông báo cập nhật thành công (tuỳ chọn):
...
Số lượng sản phẩm không đủ hoặc sản phẩm đã hết hàng:
